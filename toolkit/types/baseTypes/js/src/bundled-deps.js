/* Bundled TypeScript Toolkit Dependencies */

/// @bundleDependency arrays.arrayify.ArrayifyType
/// @bundleDependency arrays.arrayify.arrayify
/// @bundleDependency arrays.toListString.toListString
...
function isBaseType (x, types) {
    ...
    return (/** @type {TypesT} */ (arrayify(types))).includes(getBaseType(x));
